...
cats = ['สายไฟ', 'น้ำท่วม', 'ป้าย', 'ทางเท้า', 'ต้นไม้', 'ความสะอาด', 'กีดขวาง', 'ถนน', 'สัตว์จรจัด', 'ความปลอดภัย', 'ป้ายจราจร', 'สะพาน', 'การเดินทาง', 'คนจรจัด', 'เสนอแนะ', 'สอบถาม', 'ท่อระบายน้ำ', 'คลอง', 'แสงสว่าง', 'เสียงรบกวน', 'ร้องเรียน', 'จราจร', 'PM2.5', 'ห้องน้ำ']
